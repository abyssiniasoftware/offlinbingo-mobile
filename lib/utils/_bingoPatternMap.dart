...
List<List<String>> combinePatternsOr(List<List<String>> pattern1, List<List<String>> pattern2) {
...
List<List<String>> combinePatternsAnd(List<List<String>> pattern1, List<List<String>> pattern2) {
